                    ...
                    <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Valor_Unitario</th>
                                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">valor_total</th>
                                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Abono</th>
                                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Total</th>
                                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Clientes</th>
        ...
        <tr class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
                <div class="flex gap-2">
                    <span class="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-xs font-semibold text-blue-600"></span>
                </div>
            </td>
            <td class="px-6 py-4"></td>
            <td class="px-6 py-4"></td>
            ...
            <td class="px-6 py-4">
                <div class="flex justify-between gap-4">
                    ...
                    <div class="flex flex-row-reverse py-4 px-4">
                        <div>
                            <!-- aqui vienen los links para la paginacion -->
